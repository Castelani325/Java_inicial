...
import fab.relatorio.api.Domain.paciente.*;
...
public class pacienteController {
    ...
    @GetMapping
    public ResponseEntity <Page<DadosListagemPacientes>> listar (@PageableDefault (size = 4, page = 0, sort = {"nome","cpf"}) Pageable paginacao){
